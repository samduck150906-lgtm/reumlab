...
/** 포트폴리오 상세: CreativeWork + BreadcrumbList 그래프 (Experience/E-E-A-T 신호) */
export function PortfolioCreativeWorkJsonLd({
  ...
  if (keywords && keywords.length > 0) work.keywords = keywords.join(', ');
...
/** 포트폴리오 목록: CollectionPage + ItemList 그래프 */
