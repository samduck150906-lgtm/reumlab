...
// 홈 패키지와 1:1 일치 — 티어명·금액·VAT 포함 정액 표기를 index.html 가격표와 동일하게 유지한다.
const PRICING = {
  app: {
    note: '모든 금액은 VAT 포함 정액이며, 기능 범위에 따라 견적이 조정됩니다.',
    tiers: [
      { tier: '앱 라이트 MVP', price: '5,800,000원', period: '약 14일', features: ['핵심 화면 3~5개 · 기본 데이터 연동', '문의·예약 흐름', '소스코드 이관 · AI 운영 1:1 교육'] },
      { tier: '앱 스탠다드', price: '9,800,000원', period: '약 21일', featured: true, features: ['회원/로그인 + DB + 결제 또는 예약', '기본 관리자 + 실행·수정 가이드', '소스코드 이관 · AI 운영 1:1 교육'] },
      { tier: '앱 AI', price: '13,800,000원', period: '약 30일', features: ['스탠다드 + AI 기능 1종(챗봇·추천·요약)', '업무 자동화 협의', '소스코드 이관 · AI 운영 교육'] },
      { tier: '앱 프리미엄', price: '19,800,000원', period: '약 45일', features: ['멀티 기능 + AI 고도화', '운영·관리자 흐름 + 외부 연동 다수', '소스코드 이관 · AI 운영 교육'] },
    ],
  },
  web: {
    note: '모든 금액은 VAT 포함 정액이며, 페이지 수·기능 범위에 따라 조정됩니다.',
    tiers: [
      { tier: '웹 스타터', price: '980,000원', period: '약 5일', features: ['원페이지 랜딩 · 모바일 반응형', '문의·예약 CTA 연결', '소스코드 이관 · AI 수정 교육 1회'] },
      { tier: '웹 + 강력 마케팅', price: '1,960,000원', period: '약 10일', featured: true, features: ['전환 카피 설계 + 기본 SEO', 'GA·픽셀 세팅 + 광고 소재 1세트', '소스코드 이관 · AI 수정 교육 1회'] },
      { tier: '웹 비즈니스', price: '3,800,000원', period: '약 14일', features: ['멀티페이지(5p 내외) + 블로그', '예약·문의 + 간단 CMS · 기본 SEO', '소스코드 이관 · AI 운영 1:1 교육'] },
      { tier: '웹 프리미엄', price: '5,800,000원', period: '약 21일', features: ['고도화 웹앱 + 관리자 페이지', '외부 연동(결제·지도·메일 1~2종)', '소스코드 이관 · AI 운영 교육'] },
    ],
  },
  plan: {
    note: '아이디어 단계부터 함께 정리합니다. 모든 금액은 VAT 포함 정액이며 범위에 따라 조정됩니다.',
    tiers: [
      { tier: '웹 스타터', price: '980,000원', period: '약 5일', features: ['핵심 화면·기능 정의', '원페이지 랜딩 · 반응형', '소스코드 이관 · AI 수정 교육 1회'] },
      { tier: '앱 라이트 MVP', price: '5,800,000원', period: '약 14일', featured: true, features: ['핵심 화면 3~5개 · 기본 데이터 연동', '문의·예약 흐름', '소스코드 이관 · AI 운영 1:1 교육'] },
      { tier: '앱 스탠다드', price: '9,800,000원', period: '약 21일', features: ['회원/로그인 + DB + 결제 또는 예약', '기본 관리자 + 실행·수정 가이드', '소스코드 이관 · AI 운영 1:1 교육'] },
    ],
  },
};
...
function intentBlock(landing) {
  ...
  if (profile === 'cost') {
    return {
      ...
      faqs: [
        { q: `${kw}${eunneun(kw)} 보통 얼마인가요?`, a: `${svc} 비용은 기능 범위에 따라 달라집니다. VAT 포함 정액 패키지 기준으로 안내드리고, 요구사항을 알려주시면 정확한 견적을 무료로 드립니다.` },
  ...
  return {
    badge: '맞춤 제작',
    heroSub: `${kw}, 업종과 상황에 맞춰 기획부터 제작·운영까지 도와드립니다. 요구사항 정리부터 배포까지 한 흐름으로 진행하고, 소스코드를 통째로 넘겨드립니다.`,
    angle: {
      title: `왜 름랩 ${svc}인가요?`,
      body: '영업 담당과 개발 담당이 따로 움직이지 않습니다. 상담에서 정리한 요구사항이 그대로 기획·개발·배포로 이어집니다. 군더더기 없는 1회성 계약으로 진행합니다.',
      points: ['상담 내용이 그대로 개발로 이어지는 단일 창구 — 빠른 의사결정', '소스코드 전체 이관으로 외주 종속 없음', '월 관리비 없는 투명한 1회성 계약', '완료 후 직접 수정 교육 제공'],
    },
    faqs: [
