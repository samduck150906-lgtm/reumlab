...
export const COMPARES: CompareDef[] = [
  {
    ...
    faqs: [
      ...
      { q: '름랩은 어떤 프레임워크로 개발하나요?', a: 'Flutter를 주력으로 씁니다. MVP에 적합한 출시 속도·비용·유지보수 이점 때문이며, 팀 상황에 따라 다른 선택지도 상담에서 안내합니다.' },
    ],
    related: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '노코드 구독료와 개발 비용, 장기적으로 뭐가 저렴한가요?', a: '단기엔 노코드 구독이 저렴하지만, 사용량·기능이 늘면 구독료가 계속 오르고 플랫폼에 묶입니다. 개발은 초기 비용이 있어도 소스코드를 보유해 월 고정비 없이 운영·확장할 수 있어, 오래 운영할 서비스라면 총비용에서 유리한 경우가 많습니다.' },
    ],
    related: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '외주로 만들면 통제권을 잃는 것 아닌가요?', a: '소스코드·저장소·배포 권한을 이관받으면 통제권을 잃지 않습니다. 이관 조건을 계약에 명시하는 것이 핵심이며, 름랩은 이를 기본으로 하고 직접 운영 교육까지 제공해 외주사 종속 없이 통제권을 확보하도록 합니다.' },
    ],
    related: [
