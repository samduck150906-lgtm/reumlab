...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    paragraphs: [
      ...
      '세 번째는 기술 스택 선택입니다. Flutter 등 크로스플랫폼으로 iOS·Android를 한 번에 가져가면 초기 개발 인건비와 일정 리스크가 동시에 줄어듭니다. 림랩은 이런 흐름으로 패키지를 설계해, VAT 포함 정액으로 범위를 명확히 합니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '운영 체크리스트(배포 전 테스트 5분, 롤백 방법, 장애 시 연락망)를 만들어 두면 긴급 외주 의존도가 내려갑니다. 림랩 패키지에는 이런 운영 루틴을 온라인으로 전수합니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '문서는 “어디를 바꾸면 어디에 반영되는지” 스크린샷과 함께 적어 두세요. 림랩은 이런 운영 문서와 1:1 교육을 패키지에 포함합니다.',
    ],
  },
  {
