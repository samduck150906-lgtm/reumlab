...
const HOME_FAQS = [
  { q: '앱개발 외주 비용은 보통 얼마인가요?', a: '앱개발 외주 비용은 기능 범위, 화면 수, 관리자 기능, 외부 API 연동 여부에 따라 크게 달라집니다. 름랩의 Flutter 앱 MVP 패키지는 VAT 포함 499만원부터 시작합니다. 정확한 견적은 30분 무료 상담에서 안내드립니다.' },
  ...
  { q: '기획서 없이 아이디어만 있어도 상담 가능한가요?', a: '가능합니다. 아이디어와 꼭 필요한 기능 한두 가지만 있어도 상담을 시작할 수 있습니다. 수원 인계동 사무실 대면 상담은 물론 전국 비대면 상담도 가능합니다.' },
];
