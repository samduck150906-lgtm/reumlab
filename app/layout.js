...
export const metadata = {
  ...
  title: { default: '럼랩 REUMLAB | AI 앱 제작 · 창업 프로덕션 · 부트캠프 · VVIP 컨설팅', template: '%s | 럼랩 REUMLAB' },
  ...
  openGraph: {
    ...
    siteName: '럼랩 REUMLAB',
    images: [{ url: 'https://reumlab.com/og-default.png', width: 1200, height: 630, alt: '럼랩 REUMLAB' }],
  },
};
